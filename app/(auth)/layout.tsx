...
import SocialAuthForm from "@/components/(inteface)/forms/SocialAuthForm";

const AuthLayout = ({ children }: { children: ReactNode }) => {
  return (
    <main className="flex min-h-screen items-center justify-center bg-cover px-4 py-10 bg-center bg-no-repeat bg-auth-light dark:bg-auth-dark">
